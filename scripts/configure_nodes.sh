...
#git clone https://birgelee:$(cat github_personal_access_token.key)@github.com/birgelee/performance-aware-routing.git performance-aware-routing-2
#./send_cmd.py "./performance-aware-routing-2/setup_node.sh"

# Path id copy not needed for tofino experiments.
